...
object Instructions {
  ...
  def HLV                = BitPat("b0110??00000??????100?????1110011")
  def HLVX               = BitPat("b0110??00001??????100?????1110011")
  def HSV                = BitPat("b0110??1??????????100000001110011")
  ...
  def VFCVT_RTZ_XU_F_V   = BitPat("b100010??????00110001?????1010111")
  def VFCVT_RTZ_X_F_V    = BitPat("b100010??????00111001?????1010111")
  ...
  def VFWCVT_RTZ_XU_F_V  = BitPat("b100010??????01110001?????1010111")
  def VFWCVT_RTZ_X_F_V   = BitPat("b100010??????01111001?????1010111")
  ...
  def VFNCVT_RTZ_XU_F_W  = BitPat("b100010??????10110001?????1010111")
  def VFNCVT_RTZ_X_F_W   = BitPat("b100010??????10111001?????1010111")
  def VFNCVT_XU_F_W      = BitPat("b100010??????10000001?????1010111")
  def VFNCVT_X_F_W       = BitPat("b100010??????10001001?????1010111")
  def VFNCVT_F_XU_W      = BitPat("b100010??????10010001?????1010111")
  def VFNCVT_F_X_W       = BitPat("b100010??????10011001?????1010111")
  def VFNCVT_F_F_W       = BitPat("b100010??????10100001?????1010111")
  def VFNCVT_ROD_F_F_W   = BitPat("b100010??????10101001?????1010111")
  ...
  def VAMOSWAPE_V        = BitPat("b00001????????????111?????0101111")
  def VAMOADDE_V         = BitPat("b00000????????????111?????0101111")
  def VAMOXORE_V         = BitPat("b00100????????????111?????0101111")
  def VAMOANDE_V         = BitPat("b01100????????????111?????0101111")
  def VAMOORE_V          = BitPat("b01000????????????111?????0101111")
  def VAMOMINE_V         = BitPat("b10000????????????111?????0101111")
  def VAMOMAXE_V         = BitPat("b10100????????????111?????0101111")
